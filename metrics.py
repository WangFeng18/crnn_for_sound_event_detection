...
file_list = []
for id in parameter.evaluate:
    template = { 'reference_file': os.path.join(parameter.meta_dir, parameter.meta_template.format(id))
,\
                 'estimated_file': os.path.join(parameter.estimate_dir, parameter.meta_template.format(id))}
    file_list.append(template)
data = []
